...
use openfang_types::model_catalog::{
    ...
    MODELSCOPE_BASE_URL, MOONSHOT_BASE_URL, NVIDIA_NIM_BASE_URL, OLLAMA_BASE_URL, OPENAI_BASE_URL,
...
fn builtin_aliases() -> HashMap<String, String> {
    let pairs = [
        ...
        ("modelscope-kimi", "moonshotai/Kimi-K2.5"),
        ("modelscope-glm", "ZhipuAI/GLM-5"),
        ("modelscope-minimax", "MiniMax/MiniMax-M2.5"),
        ("modelscope-qwen", "Qwen/Qwen3.5-35B-A3B"),
        // Codex aliases
        ("codex", "codex/gpt-5.4"),
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        ModelCatalogEntry {
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["kimi-k2.5".into(), "modelscope-kimi".into()],
        },
        ModelCatalogEntry {
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["glm-5".into(), "modelscope-glm".into()],
        },
        ModelCatalogEntry {
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["minimax-m2.5".into(), "modelscope-minimax".into()],
        },
        ModelCatalogEntry {
            id: "Qwen/Qwen3.5-35B-A3B".into(),
            display_name: "Qwen 3.5 35B A3B".into(),
            provider: "modelscope".into(),
            tier: ModelTier::Smart,
            context_window: 32_000,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["qwen3.5-35b".into(), "modelscope-qwen".into()],
        },
        // ══════════════════════════════════════════════════════════════
        // Zhipu AI / GLM (6)
        // ══════════════════════════════════════════════════════════════
